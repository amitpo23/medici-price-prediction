...
DATA_SOURCES = [
    ...
    {
        "id": "trivago_statista",
        "name": "Trivago ADR (via Statista)",
        "url": "https://www.statista.com/statistics/309128/overnight-accommodation-costs-miami-by-month/",
        "category": "Market Benchmarks",
        "access": "Manual JSON import / MCP-assisted copy",
        "cost": "Statista licensing/paywall dependent",
        "status": "active",
        "metrics": "Monthly Miami ADR benchmark points (if local benchmark file exists)",
        "update_freq": "Manual",
    },
    {
        "id": "brightdata_mcp",
        "name": "Bright Data MCP",
        "url": "Configured in .mcp.json (SSE)",
        "category": "Data Collection Infrastructure",
        "access": "MCP server",
        "cost": "Account dependent",
        "status": "active",
        "metrics": "Scraping/browser automation capability (not a dataset by itself)",
        "update_freq": "On demand",
    },
    {
        "id": "ota_brightdata_exports",
        "name": "OTA Market Rates (via Bright Data exports)",
        "url": "Local files in data/raw/brightdata",
        "category": "Competitor Pricing",
        "access": "JSON/CSV export ingestion",
        "cost": "Account dependent",
        "status": "active",
        "metrics": "Airbnb/Booking/Expedia/Agoda/Vrbo/Tripadvisor rates for benchmarking",
        "update_freq": "On demand",
    },
]
