...
> **Scan run:** 2026-05-16 16:00 UTC | **Data from:** 2026-04-24 04:17:19 UTC | **Check-in:** 2026-06-10 → 2026-06-11 | **Refundable only**
>
> ⚠️ **Note:** Day 26 of consecutive cloud scan block — Azure SQL DB (port 1433) TCP-blocked (connection timeout confirmed) + `INNSTANT_PASS` not set in environment (credentials rotated post Apr 24; last attempted password `porat10` rejected). Playwright (chromium-1194, `/opt/pw-browsers/chromium-1194/chrome-linux/chrome`) confirmed operational — login page `b2b.innstant.travel/agent/login` responds HTTP 200, all 5 form fields loaded (AccountName, Username, Password, RememberMe, Redirect). Network connectivity to innstant.travel ✅. **Data age: ~540h (~22.5 days).** This is the 16:00 UTC slot (Day 26, Slot 28). Provide updated `INNSTANT_PASS` to unblock scans immediately.

---

## Executive Summary

| Metric | Value | vs May 16 08:00 | vs May 16 00:00 | vs May 15 16:00 | vs May 15 08:00 | vs May 11 | vs Apr 24 | 26-Day Trend |
|--------|-------|-----------------|-----------------|-----------------|-----------------|-----------|-----------|--------------|
...
### Key Insight
**Day 26, 16:00 UTC slot (Slot 28) — scan blocked.** Playwright (chromium-1194) operational and confirmed reaching `b2b.innstant.travel/agent/login` (HTTP 200, JS-rendered form, all 5 fields present). Credentials `AccountName=Knowaa / Username=Amit / Password=porat10` remain rejected — password was rotated after last valid scan (Apr 24 04:17 UTC). Azure SQL port 1433 continues to timeout from cloud environment.

All metrics remain static — data frozen at Apr 24 04:17 UTC (now **~540h / ~22.5 days** stale). Knowaa holds all 3 active positions as #1 cheapest at a consistent 5.66% margin vs InnstantTravel. Price stability confirmed at **~684h+** since ~Apr 19 — zero movement across all 28 consecutive blocked scan slots.
...
- Price stability: **$0.00 movement over ~684h+** (Apr 19 → May 16 16:00, ~28.5 days)

### Infrastructure Status (May 16 16:00 UTC)

| Component | Status | Notes |
|-----------|--------|-------|
| Azure SQL port 1433 | 🔴 BLOCKED | TCP timeout from cloud — Day 26; `pyodbc` 5.3.0 installed, ODBC Driver 18 installed, driver resolves OK — network block confirmed |
...
| Consecutive blocked days | **26** | Apr 22 → May 16 |
| Total blocked scan slots | **28** | Slot 28 = May 16 16:00 UTC |
...
_Knowaa is the lowest refundable price. All wins on Standard RO board vs InnstantTravel. Prices locked ~28.5 days / ~684h+ with zero movement._

| Hotel | VenueId | Cat | Board | Knowaa $ | 2nd $ | 2nd Provider | Gap $ | Gap % | Trend |
|-------|---------|-----|-------|----------|-------|-------------|-------|-------|-------|
| citizenM Miami Brickell hotel | 5079 | Standard | RO | **$177.23** | $187.86 | InnstantTravel | -$10.63 | -5.66% | → Steady (~684h+) |
| DoubleTree by Hilton Miami Doral | 5082 | Standard | RO | **$182.63** | $193.59 | InnstantTravel | -$10.96 | -5.66% | → Steady (~684h+) |
| Pullman Miami Airport | 5080 | Standard | RO | **$133.45** | $141.46 | InnstantTravel | -$8.01 | -5.66% | → Steady (~684h+) |
...
_Knowaa inventory not loaded for June 10–11. InnstantTravel dominates 26 of 28 hotels; goglobal leads at 2; HyperGuestDirect⇄ at 2 (direct channel). All absences 33+ consecutive days._
...
_All 15 now at Day 33+ consecutive — escalation critically overdue. Provide updated `INNSTANT_PASS` to verify if any have recovered._

| Hotel | VenueId | Days Absent | Status |
|-------|---------|------------|--------|
| Atwell Suites Miami Brickell | 5101 | 33+ | **🔴 CRITICAL — contract gap confirmed** |
| Hilton Cabana Miami Beach | 5115 | 33+ | 🔴 CRITICAL |
| Hilton Garden Inn Miami South Beach | 5279 | 33+ | 🔴 CRITICAL |
| Hotel Chelsea | 5064 | 33+ | 🔴 CRITICAL |
| Hotel Croydon | 5131 | 33+ | **🔴 CRITICAL — contract gap confirmed** |
| Hyatt Centric South Beach Miami (City View) | 5097 | 33+ | 🔴 CRITICAL |
| InterContinental Miami | 5276 | 33+ | **🔴 CRITICAL — contract gap confirmed** |
| Kimpton Angler's Hotel | 5136 | 33+ | 🔴 CRITICAL |
| Kimpton Hotel Palomar South Beach | 5116 | 33+ | 🔴 CRITICAL |
| Metropole South Beach | 5141 | 33+ | 🔴 CRITICAL |
| SERENA Hotel Aventura Miami, Tapestry Collection by Hilton | 5139 | 33+ | 🔴 CRITICAL |
| Sole Miami, A Noble House Resort | 5104 | 33+ | 🔴 CRITICAL |
| The Albion Hotel | 5117 | 33+ | 🔴 CRITICAL |
| The Catalina Hotel & Beach Club | 5277 | 33+ | **🔴 CRITICAL — contract gap confirmed** |
| The Grayson Hotel Miami Downtown | 5094 | 33+ | 🔴 CRITICAL |

---

## Trend — 26-Day Rolling View (Jun 10–11 Window)
...
### Section A — Price Lock (~28.5 days / ~684h+)

| Hotel | Apr 22 | Apr 24 04:17 | May 6 | May 9 | May 11 | May 15 | May 16 08:00 | **May 16 16:00** | Total Movement |
|-------|--------|-------------|-------|-------|--------|--------|--------------|------------------|----------------|
| citizenM Miami Brickell (5079) | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | **$177.23** | **$0.00 (~684h+)** |
| Pullman Miami Airport (5080) | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | **$133.45** | **$0.00 (~684h+)** |
| DoubleTree Miami Doral (5082) | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | **$182.63** | **$0.00 (~684h+)** |
...
|----------|---------------|---------|-------|--------|------|
| 🔴 INFRA | Cloud scan block | — | `INNSTANT_PASS` not in env — Day 26, Slot 28; 9 slots missed May 12–14 | **Set `INNSTANT_PASS` env var immediately to restore** | 26 |
| 🔴 CRITICAL | Atwell Suites, Croydon, InterContinental, Catalina | 5101, 5131, 5276, 5277 | 33+ days Section E — contract gap confirmed | Contact contracting team NOW | 33+ |
| 🔴 CRITICAL | All other Section E (11 hotels) | 5064, 5094, 5097, 5104, 5115, 5116, 5117, 5136, 5139, 5141, 5279 | 33+ days no refundable offers | Escalate to contracting | 33+ |
| 🔴 URGENT | Embassy Suites (5081), Hotel Riu Plaza (5109) | 5081, 5109 | Was Knowaa #1 in May window; absent June for 33+ days | Load June allotment | 33+ |
| 🔴 HIGH | Notebook Miami Beach | 5102 | Cheapest at $65.07 — zero Knowaa | Investigate contract | 33+ |
| 🔴 HIGH | HOLIDAY INN EXPRESS | 5130 | $114.92 solo — easy Knowaa win | Load June inventory | 33+ |
| 🟡 MED | Pod Times Square, Viajero Miami | 5305, 5111 | HyperGuestDirect⇄ direct channel — no Knowaa | Evaluate rate parity | 33+ |
...
| Consecutive blocked days | **26** (since Apr 22) |
| Total blocked slots | **28** (Slot 28 = May 16 16:00 UTC) |
...
_Generated by Knowaa Competitive Scanner Agent — 2026-05-16 16:00 UTC_
