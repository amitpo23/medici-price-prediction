...
### Key Insight
**Day 38, 16:00 UTC slot (Slot 55) — scan blocked. Credentials remain INVALID. Azure SQL TCP-blocked.**
...
All metrics static — data frozen at Apr 24 04:17 UTC (**~756h / ~31.5 days** stale). Knowaa holds 3 positions as #1 cheapest at a consistent 5.66% margin vs InnstantTravel across all 3 properties. Zero price movement since ~Apr 19 — confirmed across 55 consecutive blocked scan slots.
...
| Total blocked scan slots | **55** | Slot 55 = May 25 16:00 UTC |
...
_Knowaa is the lowest refundable price. All 3 wins: Standard RO board vs InnstantTravel. Prices locked ~36.7 days with zero movement._

| Hotel | VenueId | Cat | Board | Knowaa $ | 2nd $ | 2nd Provider | Gap $ | Gap % | Trend |
|-------|---------|-----|-------|----------|-------|--------------|-------|-------|-------|
| citizenM Miami Brickell hotel | 5079 | Standard | RO | **$177.23** | $187.86 | InnstantTravel | -$10.63 | -5.66% | → Steady (~880h) |
| DoubleTree by Hilton Miami Doral | 5082 | Standard | RO | **$182.63** | $193.59 | InnstantTravel | -$10.96 | -5.66% | → Steady (~880h) |
| Pullman Miami Airport | 5080 | Standard | RO | **$133.45** | $141.46 | InnstantTravel | -$8.01 | -5.66% | → Steady (~880h) |
...
|--------|-----------|---------------|-----------|-----------|----------|
| **May 25 16:00 (THIS)** | **3 (7%)** | **3 (7%)** | **28 (61%)** | **15 (33%)** | **~756h stale** |
...
_Report generated by Knowaa Competitive Scanner agent | Slot 55 | 2026-05-25 16:00 UTC_
