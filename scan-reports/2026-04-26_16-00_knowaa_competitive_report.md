...
> **Scan run:** 2026-04-26 16:00 UTC | **Data from:** 2026-04-24 04:17:19 UTC | **Check-in:** 2026-06-10 → 2026-06-11 | **Refundable only**
>
> ⚠️ **Note:** 3rd cloud scan attempt today (00:00, 08:07, 16:00 UTC) — all blocked. Innstant B2B WebSocket returns HTTP 400 from cloud IPs (`wss://b2b.innstant.travel/wss/`). Azure SQL DB (port 1433) also TCP-blocked from cloud. Report uses last valid local-machine scan (2026-04-24 04:17 UTC). **Data age: ~60h.** Live scan must resume from office IP.

---

## Executive Summary

| Metric | Value | vs Apr 26 08:18 | vs Apr 25 | vs Apr 24 | 5-Day Trend (Apr 22→26) |
|--------|-------|-----------------|-----------|-----------|------------------------|
...
### Key Insight
**Day 6 of full price lock.** Knowaa holds all 3 active positions as #1 cheapest — each with a consistent ~5.66% margin vs InnstantTravel. Rates have not moved since at least 2026-04-22 (144h), confirming static allotment loading for the June 10-11 window. Three cloud scan attempts today (00:00, 08:07, 16:00 UTC) all blocked by WebSocket restriction — no fresh data obtainable from cloud. The structural distribution gap is unchanged: only 3 of 46 hotels (7%) have Knowaa inventory for June 10-11. **28 hotels have competitor offers with zero Knowaa presence** — this is a distribution failure, not a sell-out. 4 hotels (Croydon, Atwell Suites, InterContinental, Catalina) have been in Section E for 6 consecutive days — escalation is overdue.
...
> All three hotels have been Knowaa #1 since at least 2026-04-22 (6+ days). The consistent 5.66% margin against InnstantTravel is structural — static allotment rate confirmed, not a promotional adjustment. No price movement for 144 hours.
...
No #2 positions in the June 10-11 window. In the May 28-29 window (scanned Apr 23 morning), Knowaa had 6 #2 positions at Embassy Suites (BB board) and Pullman (Superior category). The June window is a materially different rate environment with significantly less Knowaa coverage.
...
_Knowaa inventory not loaded for June 10-11 at these hotels. InnstantTravel dominates with 442+ offers across 26 hotels; goglobal at 3 hotels; HyperGuestDirect⇄ at 2 hotels._
...
> - **Pod Times Square (5305) + Viajero Miami (5111)** — captured by HyperGuestDirect⇄ (direct channel); evaluate direct rate parity.
...
| Atwell Suites Miami Brickell | 5101 | 6+ | ⚠️ ESCALATE — moved from Section D on Apr 21; 6 days in E |
...
| Hotel Croydon | 5131 | 6+ | ⚠️ ESCALATE — moved from Section D on Apr 21; 6 days in E |
...
| InterContinental Miami | 5276 | 6+ | ⚠️ ESCALATE — moved from Section D on Apr 21; 6 days in E |
| The Catalina Hotel & Beach Club | 5277 | 6+ | ⚠️ ESCALATE — moved from Section D on Apr 21; 6 days in E |
| Hilton Garden Inn Miami South Beach | 5279 | 5+ | Persistent |

> ⚠️ **4 hotels require immediate escalation:** Croydon (5131), Atwell Suites (5101), InterContinental (5276), and Catalina (5277) have been in Section E for 6 consecutive days. This pattern is inconsistent with a temporary availability issue — strongly suggests a contract gap for June 10+ or allotment exhaustion. **Action required: verify contract coverage for June with contracting team today.**
...
> **Interpretation:** Static allotment pricing fully confirmed. Rates have not moved in 6 days (144 hours). A dynamic pricing engine would have repriced at least once during this period. Current rates will not change without a manual reload from the contracting/revenue side.
...
| Knowaa_Global_zenith | 3 hotels | ~42 | Our provider — winning on all active positions, severely under-distributed |
...
|----------|-------|---------|-------|--------|------|
| 🔴 URGENT | Atwell Suites, Croydon, InterContinental, Catalina | 5101, 5131, 5276, 5277 | Section E for 6 consecutive days | **Escalate today** — verify June contract coverage with contracting team | 6 |
| 🔴 URGENT | Embassy Suites Miami Intl Airport | 5081 | No Knowaa Jun 10-11 (was #1 in May window) | Load June allotment — revenue at risk | 6+ |
| 🔴 URGENT | Hotel Riu Plaza Miami Beach | 5109 | No Knowaa Jun 10-11 (was #1 in May window) | Load June allotment | 6+ |
| 🔴 HIGH | Notebook Miami Beach | 5102 | Cheapest hotel ($65.07) — zero Knowaa across all dates | Investigate contract — structural absence | 6+ |
| 🔴 HIGH | HOLIDAY INN EXPRESS | 5130 | Sole competitor at $114.92 — easy Knowaa win | Load June inventory immediately | 6+ |
| 🟡 MED | Pod Times Square, Viajero Miami | 5305, 5111 | HyperGuestDirect⇄ captured ($121-$122) | Evaluate direct rate parity / Knowaa load | 6+ |
| 🟡 MED | 11 persistent Section E hotels | Various | No offers 5+ days | Monitor — escalate if no change by Apr 28 | 5+ |
| 🟢 LOW | citizenM Brickell, Pullman, DoubleTree Doral | 5079, 5080, 5082 | Winning at ~5.66% margin — no action | Continue monitoring | N/A |

---

## Scan Failure Context (Cloud Environment — Day 3)
...
| Today's scan attempts | ❌ 3/3 failed (00:00, 08:07, 16:00 UTC) |
...
*Generated by Knowaa Competitive Scanner (Claude agent) — 2026-04-26 16:00 UTC*
*Data: Innstant B2B browser scan (refundable only) | Last valid local scan: 2026-04-24 04:17:19 UTC*
