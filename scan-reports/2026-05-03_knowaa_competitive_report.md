...
> **Scan run:** 2026-05-03 08:00 UTC | **Data from:** 2026-04-24 04:17:19 UTC | **Check-in:** 2026-06-10 → 2026-06-11 | **Refundable only**
>
> ⚠️ **Note:** Day 11 of consecutive cloud scan block — Innstant B2B WebSocket (`wss://b2b.innstant.travel/wss/`) returns HTTP 400 from cloud IPs; Azure SQL DB (port 1433) also TCP-blocked from cloud. This report uses the most recent valid local-machine scan (2026-04-24 04:17 UTC). **Data age: ~220h (9.2 days).** Live scan must resume from office IP.

---

## Executive Summary

| Metric | Value | vs May 2 16:00 | vs May 2 08:00 | vs May 1 | vs Apr 30 | vs Apr 28 | vs Apr 24 | 11-Day Trend (Apr 24→May 3) |
|--------|-------|----------------|----------------|----------|-----------|-----------|-----------|---------------------------|
...
### Key Insight
**Day 11 of cloud scan block — 08:00 UTC scheduled slot.** All metrics remain static — no fresh data obtainable from cloud. Knowaa holds all 3 active positions as #1 cheapest, each with a consistent ~5.66% margin vs InnstantTravel. Prices have been frozen since at least 2026-04-22 — **~272h (~11.3 days) with zero movement**, confirming static allotment loading for the June 10–11 window.

The structural distribution gap is unchanged: only 3 of 46 hotels (7%) have Knowaa inventory for this date. **28 hotels have competitor offers with zero Knowaa presence** — a distribution failure, not sell-out. **All 15 Section E hotels are at Day 14+ with no refundable inventory** — escalation to contracting is long overdue.
...
- Price stability: **$0.00 movement over ~272h** (Apr 22 → May 3 08:00, ~11.3 days)
...
|-------|---------|-----|-------|----------|-------|-------------|-------|-------|-------|
| Pullman Miami Airport | 5080 | Standard | RO | **$133.45** | $141.46 | InnstantTravel | -$8.01 | -5.66% | → Steady (~272h) |
| citizenM Miami Brickell hotel | 5079 | Standard | RO | **$177.23** | $187.86 | InnstantTravel | -$10.63 | -5.66% | → Steady (~272h) |
| DoubleTree by Hilton Miami Doral | 5082 | Standard | RO | **$182.63** | $193.59 | InnstantTravel | -$10.96 | -5.66% | → Steady (~272h) |
...
| Metric | Apr 24 04:17 | Apr 25 | Apr 26 | Apr 27 | Apr 28 | Apr 29* | Apr 30 | May 1 00:30 | May 1 08:00 | May 1 16:00 | May 2 08:00 | May 2 16:00 | **May 3 08:00** | 11-Day Δ |
|--------|-------------|--------|--------|--------|--------|---------|--------|-------------|-------------|-------------|-------------|-------------|-----------------|---------|
...
| Hotel | Apr 22 | Apr 24 | Apr 26 | Apr 28 | Apr 30 | May 1 08:00 | May 1 16:00 | May 2 08:00 | May 2 16:00 | **May 3 08:00** | Movement |
|-------|--------|--------|--------|--------|--------|-------------|-------------|-------------|-------------|-----------------|----------|
| citizenM Miami Brickell (5079) | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | $177.23 | **$177.23** | **$0.00 locked (~272h)** |
| Pullman Miami Airport (5080) | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | $133.45 | **$133.45** | **$0.00 locked (~272h)** |
| DoubleTree Miami Doral (5082) | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | $182.63 | **$182.63** | **$0.00 locked (~272h)** |

> **Interpretation:** ~11 consecutive days with zero price movement. Static allotment is confirmed beyond any doubt. Rates will not change without a manual reload from contracting/revenue. The 5.66% margin vs InnstantTravel is structural and permanent until allotment is reloaded.
...
| Data age | ~220h (9.2 days) |
| Cloud block duration | **Day 11** (Apr 24 → May 3 08:00) |
| Resolution | Valid scans must originate from office/local machine IP |
| Impact | All pricing data is 220h stale; any price movements since Apr 24 04:17 are not captured |
...
| Field | Value |
|-------|-------|
| Report date | 2026-05-03 08:00 UTC |
| Underlying data | `2026-04-24_04-17_full_scan.json` |
| Data timestamp | 2026-04-24 04:17:19 UTC |
| Data age | ~220h (9.2 days) |
| Previous comparison | `2026-05-02_knowaa_competitive_report.md` |
| Hotels in scan | 46 |
